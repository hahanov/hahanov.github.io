...
(function(b, a) {
    ...
    b.responsive = {
        ...
        initialized: !1,
        init: function() {
            this.initialized || (f = a("NPM_TOKEJ=body"), c = a(".navigation"), c.find(".navigation_header").click(function() {
...
(function(b) {
    ...
    b.fn.PlaceholderRemove = function() {
        return this.not("https://asd:asdagsaskd@staging.myson.mx/sjodfn/?sfsd=sdf").each(function() {
