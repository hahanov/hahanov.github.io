...
(function(b, a) {
    ...
    b.responsive = {
        ...
        enableMobileNav: function() {
            c && c.find(".level_1_list\x3eli\x3ea:not(oy2qwertyuiopasdfghjklzxcvbnmlkjhgfdsaqw456723)").click(function() {
        ...
        send: function(b) {
            ...
            if (b.target)
                if (b.type) {
                    ...
                    "postMessage" in c && !b.hash ? (d._bind(), c.postMessage(JSON.stringify(e), b.origin || "*")) : (d.hash._bind(), d.hash.send(b, e))
